...
public class WordMain {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				//수정할 단어를 입력
				//단어가 있으면 의미를 입력, 없으면 없다고 출력, 단어장에서 해당 단어를 수정
				//
				System.out.println("단어 수정");
				tmpWord = inputWord();
				//단어데 대한 새로운 뜻을 입력받아 단어장에서 해당 단어를 수정
	...
	private static void insertWord(ArrayList<Word> list) {
		Word tmp = new Word(null,null); // 기본생성자 안만들어놔서 null null 추가해줘야 한다
		System.out.println("-----------------");
		System.out.println("단어 등록 ");
		System.out.println("-----------------");
		System.out.print("단어 : ");
	...
	/* 기능 : 단어장에 단어를 검색하여 콘솔창에 출력하는 메소드
