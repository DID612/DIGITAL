...
//		num = count; 대신에 기본생상자 호출 this();
	...
	public boolean equals(Object obj) {
		// 하나의 객체를 참조변수 두개가 공유
		if (this == obj) // 참조변수 주소비교, 같은 객체를 공유했는지
			return true;
		// 참조변수 obj가 객체와 연결이 안된 상태, 비교 대상이 없는 경우 
		if (obj == null)
			return false;
		// generate hashCode() and equals()를 이용하면
		// 기본적으로 클래스가 다르면 다르다고 판별하지만, Board 클래스에서는
		// 게시글 번호를 이용하여 같다 다르다를 판단하기 때문에
		...
		// 모든 Object 클래스가 올 수 있기 때문에 형변환을 해줘야한다.
	...
	public String toString() {
		return "게시글 [번호=" + num + ", 제목e=" + title + ", 작성자=" + writer
				+ ", 작성일=" + getRegisterDate() + "]";
	}
	public void print() {
		System.out.println("---------------------");
	...
	public boolean equalsByTitle(String str, String option) {
		//수정 제목
		if(option.equals("제목")) {
