...
public class StaticTest {
	...
	public static void main(String[] args) {
		/* 일반 멤버 변수 : 객체 멤버 변수 / 메소드
		 * static 멤버 변수 : 클래스 멤버 변수 / 메소드
		 * 일반은 객체가 호출하고, static은 클래스가 호출한다.
		 * 단. static은 객체도 호출 가능
		 * 클래스 : 설계도
		 * 객체 : 설계도로 만들어진 제품1, 제품2 ...
		 * 일반 멤버는 각 객체마다 다른 값을 가짐
		 * 클래스 맴버는 모든 객체가 동일한 값을 가짐
