...
//		System.out.println(today);
		//매개변수지역변수 갈색, 멤버변수 파란색, 기울어져있으면 static, 굵으면 final. 스태틱이니까 calendar가 나오는것
		/* get(int field) :  field 값에 따라 년, 월, 일, 주 등의 다양한
		 * 정보를 정수로 변환한다.
		 * 월의 경우 0~11을 반환
...
//		System.out.println("오전(0), 오후(1) : "+ today.get(Calendar.AM_PM));
		...
		System.out.println(year+"-"+month+"-"+day+" "+dayOfWeekString+"요일");
